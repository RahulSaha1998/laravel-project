    ...
    <table align="center" width="50%">
        <tr>
	     ...
	     <h2><u>Customer Details</u></h2>
		     ...
		     <tr>
			   <td>Name:</td>
			   <td><input id="name" type="text" placeholder="Name" name="name" value="<?php echo $name;?>"<br>
			   <span id="err_name"> <?php echo $err_name;?> </span></td>
			 </tr>
			 <tr>
			   <td>Phone Number:</td>
			   <td><input id="number" type="text" name="number" placeholder="+880" value="<?php echo $number; ?>"<br>
			...
			<tr>
			<td colspan="1" align="right" ><input type="submit" name="submit" value="Next" ></td>		
			</tr>
		 </table>
                        </fieldset>
                    </form>
